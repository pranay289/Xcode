package com.pranay.app1.Games.flappybird;
...
public class FlappyGameactivity extends AppCompatActivity {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message message) {
            switch (message.what) {
                case UPDATE: {
                    if (flappyGameview.isAlive()) {
                        isGameOver = false;
                        flappyGameview.update();
                    } else {
                        if (isGameOver) {
                            break;
                        } else {
                        ...
                        alertDialog = new AlertDialog.Builder(FlappyGameactivity.this);
                        alertDialog.setTitle("GAME OVER");
                        alertDialog.setMessage("Score: " + String.valueOf(flappyGameview.getScore()) +
                                "\n" + "Would you like to RESTART?");

                        databaseReference.child(firebaseAuth.getCurrentUser().getUid()).child("flappy_score").setValue(String.valueOf(flappyGameview.getScore()));
                        ...
                        alertDialog.setNegativeButton("NO", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                FlappyGameactivity.this.onBackPressed();
                            }
                        });
                        alertDialog.show();
                    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (gameMode == TOUCH_MODE) {
            // Jump listener
            flappyGameview.setOnTouchListener(new View.OnTouchListener() {
                @Override
                ...
                public void run() {
                    ...
                    while (isGetVoiceRun) {
                        ...
                        if (volume > volumeThreshold) {
                            FlappyGameactivity.this.flappyGameview.jump();
    ...
    private void initViews() {
        flappyGameview = findViewById(R.id.game_view);
    ...
    private void setNewTimer() {
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                FlappyGameactivity.this.handler.sendEmptyMessage(UPDATE);
