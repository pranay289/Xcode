...
import com.pranay.app1.Games.flappybird.domain.Pipe;
...
public class FlappyGameview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public FlappyGameview(Context context, AttributeSet a) {
        super(context, a);
    ...
    public FlappyGameview(Context context, AttributeSet a, int b) {
        super(context, a, b);
            ...
            if ((pipe.getPositionX() >= measuredWidth / 2.0f - pipeWidth / 2.0f - 100.0f / 2.0f) &&
                ...
                if ((positionY <= measuredHeight - pipe.getHeight() - gap + 50.0f / 2.0f) ||
                    ...
                    if (pipe.getPositionX() - pipeVelocity <
                        ...
                        if (context instanceof FlappyGameactivity) {
                            ((FlappyGameactivity) context).updateScore(score);
                            ((FlappyGameactivity) context).playScoreMusic();
                        }
                    }
                }
            }
